...
var ARTEMIS = (function (ARTEMIS) {
  ...
  // of our module
  init.$inject = ["HawtioNav", "workspace", "viewRegistry", "helpRegistry", "preferencesRegistry", "localStorage", "jolokia", "ARTEMISService", "$rootScope", "preLogoutTasks", "$templateCache"];
...
(function (ARTEMIS) {
  ...
  TreeController.$inject = ["$scope", "$location", "workspace", "localStorage"];
  ...
  ARTEMIS.module.controller("ARTEMIS.TreeHeaderController", TreeHeaderController);
  ARTEMIS.module.controller("ARTEMIS.TreeController", TreeController);
...
var ARTEMIS = (function (ARTEMIS) {
   ...
   */
  PreferencesController.$inject = ["$scope", "localStorage", "userDetails"];
  function PreferencesController($scope, localStorage, userDetails) {
    'ngInject';
  ...
  ARTEMIS.module.controller("ARTEMIS.PreferencesController", PreferencesController);
...
var ARTEMIS = (function (ARTEMIS) {
   ...
   */
  AddressController.$inject = ["$scope", "workspace", "ARTEMISService", "jolokia", "localStorage"];
  function AddressController($scope, workspace, ARTEMISService, jolokia, localStorage) {
    'ngInject';
  ...
  ARTEMIS.module.controller("ARTEMIS.AddressController", AddressController);
...
var ARTEMIS = (function (ARTEMIS) {
  ...
  AddressesController.$inject = ["$scope", "$location", "workspace", "jolokia", "localStorage", "artemisAddress"];
...
var ARTEMIS = (function (ARTEMIS) {
  ...
  BrokerDiagramController.$inject = ["$scope", "$compile", "$location", "localStorage", "ARTEMISService", "jolokia", "workspace", "$routeParams"];
  function BrokerDiagramController($scope, $compile, $location, localStorage, ARTEMISService, jolokia, workspace, $routeParams) {
    'ngInject';
  ...
  ARTEMIS.module.controller("ARTEMIS.BrokerDiagramController", BrokerDiagramController);
...
var ARTEMIS = (function (ARTEMIS) {
  ...
  BrowseQueueController.$inject = ["$scope", "workspace", "ARTEMISService", "jolokia", "localStorage", "artemisMessage", "$location", "$timeout"];
  function BrowseQueueController($scope, workspace, ARTEMISService, jolokia, localStorage, artemisMessage, $location, $timeout) {
    'ngInject';
  ...
  ARTEMIS.module.controller("ARTEMIS.BrowseQueueController", BrowseQueueController);
...
var ARTEMIS = (function (ARTEMIS) {
  ...
  ConnectionsController.$inject = ["$scope", "$location", "workspace", "jolokia", "localStorage", "artemisConnection", "artemisSession"];
  function ConnectionsController($scope, $location, workspace, jolokia, localStorage, artemisConnection, artemisSession) {
    'ngInject';
  ...
  ARTEMIS.module.controller("ARTEMIS.ConnectionsController", ConnectionsController);
...
var ARTEMIS = (function (ARTEMIS) {
  ...
  ConsumersController.$inject = ["$scope", "$location", "workspace", "jolokia", "localStorage", "artemisSession", "artemisConsumer", "artemisQueue", "artemisAddress"];
  function ConsumersController($scope, $location, workspace, jolokia, localStorage, artemisSession, artemisConsumer, artemisQueue, artemisAddress) {
    'ngInject';
      ...
      if (workspace.selection) {
        ...
        if (mbean) {
          jolokia.request({
            ...
            Core.onSuccess($scope.loadTable(), {
              error: function (response) {
  ...
  ARTEMIS.module.controller("ARTEMIS.ConsumersController", ConsumersController);
...
var ARTEMIS = (function (ARTEMIS) {
  ...
  ProducersController.$inject = ["$scope", "$location", "workspace", "jolokia", "localStorage", "artemisAddress", "artemisSession", "artemisProducer"];
  function ProducersController($scope, $location, workspace, jolokia, localStorage, artemisAddress, artemisSession, artemisProducer) {
    'ngInject';
  ...
  ARTEMIS.module.controller("ARTEMIS.ProducersController", ProducersController);
...
var ARTEMIS = (function (ARTEMIS) {
   ...
   * Controller for the Create interface
   */
  QueueController.$inject = ["$scope", "workspace", "ARTEMISService", "jolokia", "localStorage"];
  function QueueController($scope, workspace, ARTEMISService, jolokia, localStorage) {
    'ngInject';
  ...
  ARTEMIS.module.controller("ARTEMIS.QueueController", QueueController);
...
var ARTEMIS = (function (ARTEMIS) {
  ...
  QueuesController.$inject = ["$scope", "$location", "workspace", "jolokia", "localStorage", "artemisSession", "artemisQueue"];
  function QueuesController($scope, $location, workspace, jolokia, localStorage, artemisSession, artemisQueue) {
    'ngInject';
  ...
  ARTEMIS.module.controller("ARTEMIS.QueuesController", QueuesController);
...
var ARTEMIS;
(function (ARTEMIS) {
  SendMessageController.$inject = ["$route", "$scope", "$element", "$timeout", "workspace", "ARTEMISService", "jolokia", "localStorage", "$location", "artemisMessage"];
  var DELIVERY_PERSISTENT = "2";

  function SendMessageController($route, $scope, $element, $timeout, workspace, ARTEMISService, jolokia, localStorage, $location, artemisMessage) {
    'ngInject';
  ...
  ARTEMIS.module.controller("ARTEMIS.SendMessageController", SendMessageController);
...
var ARTEMIS = (function (ARTEMIS) {
  ...
  SessionsController.$inject = ["$scope", "$location", "workspace", "jolokia", "localStorage", "artemisConnection", "artemisSession", "artemisConsumer", "artemisProducer"];
